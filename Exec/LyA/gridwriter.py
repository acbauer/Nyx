...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      realadaptorinput = coprocessor.CreateProducer( datadescription, "input" )
      grid = realadaptorinput.GetClientSideObject().GetOutputDataObject(0)
      adaptorinput = ProcessIdScalars(Input=realadaptorinput)
      filename = None
...
def DoCoProcessing(datadescription):
    ...
    #print("gridwriter.py in DCP!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", datadescription.GetTimeStep())
